...
data_folder = os.path.join(script_dir, "data", "dataA", "dataAG")

output_folder = os.path.join(script_dir, "output", "outputA", "outputAG")
...
if df.empty:
    ...
    global_output = os.path.join(
        output_folder,
        "global_failure_summary_AG.xlsx"
    )
