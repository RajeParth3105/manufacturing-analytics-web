...
data_folder = os.path.join(script_dir, "data", "dataB", "dataBF")

output_folder = os.path.join(script_dir, "output", "outputB", "outputBF")
...
if df.empty:
    ...
    global_output = os.path.join(
        output_folder,
        "global_failure_summary_BF.xlsx"
    )
