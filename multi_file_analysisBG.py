...
data_folder = os.path.join(script_dir, "data", "dataB", "dataBG")

output_folder = os.path.join(script_dir, "output", "outputB", "outputBG")
...
if df.empty:
    ...
    global_output = os.path.join(
        output_folder,
        "global_failure_summary_BG.xlsx"
    )
