...
data_folder = os.path.join(script_dir, "data", "dataC", "dataCF")

output_folder = os.path.join(script_dir, "output", "outputC", "outputCF")
...
if df.empty:
    ...
    global_output = os.path.join(
        output_folder,
        "global_failure_summary_CF.xlsx"
    )
