...
data_folder = os.path.join(script_dir, "data", "dataC", "dataCG")

output_folder = os.path.join(script_dir, "output", "outputC", "outputCG")
...
if df.empty:
    ...
    global_output = os.path.join(
        output_folder,
        "global_failure_summary_CG.xlsx"
    )
